...
# Streamlit UI layout with improved colors
def main():
    ...
    st.markdown("<h1 style='text-align: center; color: #2E86C1;'>Cold Email Generator</h1>", unsafe_allow_html=True)
    st.write("Generate personalized cold emails quickly and easily!")

    # Background color using Streamlit built-in features
    st.markdown(
        """
        <style>
        .main {
