...
# Streamlit UI layout with clean colors
def main():
    ...
    # Title with a darker color
    st.markdown("<h1 style='text-align: center; color: #2C3E50;'>Cold Email Generator</h1>", unsafe_allow_html=True)
    st.write("Generate personalized cold emails quickly and easily!")

    # Clean white background and text styling using built-in features
    st.markdown(
        """
        <style>
        body {
    ...
    # Button with better color styling
    st.markdown(
        """
        <style>
        .stButton > button {
